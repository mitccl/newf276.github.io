...
OPENMETA_TV_FOLDER = xbmcaddon.Addon('script.meta').getSetting('tv_library_folder') if xbmc.getCondVisibility('System.HasAddon(script.meta)') else None
OPENMETA_MOVIE_FOLDER = xbmcaddon.Addon('script.meta').getSetting('movies_library_folder') if xbmc.getCondVisibility('System.HasAddon(script.meta)') else None
