...
def _find_cache_version():
	...
	try:
		...
		print('penguin Addon Data Path Does not Exist. Creating Folder....')
		ad_folder = control.transPath('special://home/userdata/addon_data/plugin.video.penguin')
	...
	try:
		curVersion = control.addon('plugin.video.penguin').getAddonInfo('version')
