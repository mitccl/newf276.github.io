...
class Navigator:
	...
	def tools(self):
		...
		self.addDirectoryItem(32506, 'contextpenguinSettings', 'icon.png', 'DefaultAddonProgram.png', isFolder=False)
		#-- Providers - 4
	...
	def addDirectoryItem(self, name, query, thumb, icon, context=None, queue=False, isAction=True, isFolder=True, isPlayable=False, isSearch=False, table=''):
		...
		cm.append(('[COLOR red]penguin Settings[/COLOR]', 'RunPlugin(%s?action=openSettings)' % sysaddon))
